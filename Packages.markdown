...
Browse packages, look up a title, and download what you need.

<div
  class="archive-search"
  data-archive-search
  data-source="https://horie.synology.me:8443/api/v1/folders/Packages/files"
  data-browser-label="Packages"
  data-item-label-singular="package"
  data-item-label-plural="packages"
  data-page-limit="100">
  <label class="archive-search-label" for="packages-filter">Search</label>
  <div class="archive-search-toolbar">
    <input
      ...
      type="search"
      inputmode="search"
      placeholder="Type part of a package name or path"
      autocomplete="off"
  ...
  <p class="archive-search-summary" data-archive-search-summary>Loading packages...</p>
  ...
  <p class="archive-search-empty" data-archive-search-empty hidden>No packages are available right now.</p>
