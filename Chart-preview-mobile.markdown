...
<div class="cpm-shell" data-cpm-shell>
  ...
  <footer class="cpm-bottom" data-cpm-bottom hidden>
    <button type="button" class="cp-btn cp-btn-icon cp-btn-play"
      ...
      <svg class="cpm-play__icon cpm-play__icon--play" viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true"><polygon points="6,4 20,12 6,20"/></svg>
      <svg class="cpm-play__icon cpm-play__icon--pause" viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true" hidden><rect x="5" y="4" width="5" height="16"/><rect x="14" y="4" width="5" height="16"/></svg>
    </button>
